...
insert into student(id,name,passport_id) values(20003,'Jane',40002);
...
insert into student_course(students_id,courses_id) values(20001,10001);
insert into student_course(students_id,courses_id) values(20002,10001);
insert into student_course(students_id,courses_id) values(20003,10001);
insert into student_course(students_id,courses_id) values(20001,10003);